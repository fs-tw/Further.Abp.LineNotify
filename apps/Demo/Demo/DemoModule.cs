...
public class DemoModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "a0e6da3a-0b97-45a9-8f42-fc5ea0a98829");
            });
        }
    }
    ...
    {
        Configure<LineNotifyOptions>(options =>
        {
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpAutoMapperOptions>(options =>
        {
             ...
             */
            options.AddMaps<DemoModule>(/* validate: true */);
        });
    }
